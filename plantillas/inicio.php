<div class="c-slider" id="c-slider">
		<div class="slider" id="slider">
			...
			<div class="botones"><a class="boton1" href="#">Programa</a><a class="postula boton2">Postula</a></div>
			</section>
			<section class="slider-section slider-img-2">
			<p class="slider-text">Importantes Empresas de la Región</p>
			<div class="botones"><a class="boton1" href="#">Desafios</a><a class="postula boton2">Postula</a></div>
			</section>
			<section class="slider-section slider-img-3">
			<p class="slider-text">texto 3</p>
			<div class="botones"><a class="boton1" href="#">empresas</a><a class="postula boton2">Postula</a></div>
			</section>
		</div>
